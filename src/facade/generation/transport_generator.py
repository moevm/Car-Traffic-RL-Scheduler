...
class TransportGenerator:
    def __init__(self):
        self.__transport_generator_counter = 0
    ...
    def generate(self, last_target_nodes_data):
        for last_target_node_data in last_target_nodes_data:
            ...
            traci.vehicle.add(self.__transport_generator_counter, route_id)
            traci.vehicle.setColor(self.__transport_generator_counter, self.__generate_color())
            self.__transport_generator_counter += 1
